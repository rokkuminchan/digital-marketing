  ...
  memberIntroduction: {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "郵政電信工芸 学院での専攻はITです。大学卒業して担当したプロジェクトは病院や銀行や電子情 報やイントラネットに関するものです。私はテスターとし て参加していました。プロジェクトの開発環境はジャーバ 、シェアポイント、アイオーエスやアンドロイドなどです 。調査、分析、テスト、管理を担当しました。将来、色々 な技術を学びたいです。",
      },
      {
        title: "ハ・ラム ・ヴィエン",
        image: {
        ...
        description:
          "ダナン工科大学の電子通信学部を卒業した後組込システムに約二年間働きました。車メータのソフトに関する仕事、詳細設計・コーディング・テストなどの開発を経験しました。日本にてITの知識や経験をもっと伸ばしていきたいと思い、ワールド会社に入社して、今まで1年半働いています。日本に就職する目的は、技術・スキルを向上させて、日本語を勉強します。",
      },
      {
        title: "ヴー・アイン・ドゥック",
        image: {
        ...
        description:
          "山口短期大学情報メディア学部を卒業しました。出身はベトナムのハノイです。来日してからちょうど２年迎えました。経験が浅くて分からないことが多いかもしれませんがワルードチームでは”一人じゃない”で先輩たちは優しく教え頂いた本当に有り難い！ 顧客満足のため、良い品質、生産性を高めるようにすると考えています。 精一杯頑張りますので、宜しくお願い致します！",
      },
    ],
  },
  worldRecruitHistory: {
      ...
      },
      {
        ...
        description: [
          ...
          },
          {
            title: "特徴",
            subtitle: [
              "ダナン工科大学は、ダナン大学傘下の技術系大学。ダナン工科大学の卒業生たちの多くが専門家として、ベトナム国内の学術、経済、教育などの発展を支えている。大学の位置するダナン市は、ベトナム５大都市のひとつです。",
            ],
          },
          {
            title: "規模",
